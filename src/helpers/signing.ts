...
export const signUserOp = async ({ account, userOp }: { account: PrivateKeyAccount; userOp: object }) => {
    console.log('Getting UserOp Hash');
    const userOperationHash = getUserOperationHash({ userOperation: userOp, entryPointAddress: ENTRY_POINT_ADDRESS, chainId: 421614n });
